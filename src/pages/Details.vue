...
axios
    .get<MovieModel>('https://movie.pequla.com/api/movie/' + id)
    .then((rsp) => {
        ...
        <div class="col-md-8">
          <div class="card-body p-4">
            ...
            <div class="details-grid">
              <div>
                <span class="text-body-secondary">Movie ID</span>
                <strong>{{ movie.movieId }}</strong>
              </div>

              <div>
                <span class="text-body-secondary">Internal ID</span>
                <strong>{{ movie.internalId }}</strong>
              </div>
              ...
              <div>
                <span class="text-body-secondary">Updated</span>
                <strong>{{ formatDate(movie.updatedAt) }}</strong>
              </div>
            </div>
          </div>
        </div>
